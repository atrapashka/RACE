...
enum pointsGameScreen {
    ...
    case markupRightInitialPoint
    case infoViewInitialPoint
    case startLabelInitialPoint
    case infoViewAnimationPointOne
    case infoViewAnimationPointTwo
    case infoViewAnimationPointThree
